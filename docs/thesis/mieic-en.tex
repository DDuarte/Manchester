...
\include{chapter2} % literature review: e-commerce
\include{chapter3} % literature review: simulation
\include{chapter4} % literature review: models
\include{chapter5} % method
\include{chapter6} % implementation
\include{chapter7} % validation
\include{chapter8} % conclusion & future work
