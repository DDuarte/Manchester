...
\include{chapter2} % state of the art: e-commerce
\include{chapter3} % state of the art: simulation
\include{chapter4} % state of the art: models
\include{chapter5} % problem & solution
\include{chapter6} % conclusion & future work
