...
\usepackage{booktabs,makecell,slashbox}
...
\thesisdate{June 28, 2016}

%%Uncomment next line for copyright text if used
%\copyrightnotice{Name of the Author, 2008}

\supervisor{Supervisor}{Hugo Sereno Ferreira, PhD}

%% Uncomment next line if necessary
\supervisor{Second Supervisor}{João Azevedo, MSc}

%% Uncomment committee stuff in the final version if used
\committeetext{Approved in oral examination by the committee:}
\committeemember{Chair}{Henrique L. Cardoso}
\committeemember{External Examiner}{Pedro Ribeiro}
\committeemember{Supervisor}{Hugo Sereno Ferreira}
\signature
...
\include{chapter2b} % literature review
\include{chapter2c} % literature review
\include{chapter3} % implementation
\include{chapter4} % validation
\include{chapter5} % conclusion & future work
